...
export const addProductStore = (id, data) => api.post(`/products/${id}/stores`, data);
export const removeProductStore = (id, storeId) =>
  api.delete(`/products/${id}/stores/${storeId}`);
...
export const getStatsStockValue = () => api.get('/stats/stock-value');
export const getStatsPurchaseCosts = (params) => api.get('/stats/purchase-costs', { params });
...
export const syncStockListToHa = () => api.post('/stock-list/ha-sync');
export const getHaStockStatus = () => api.get('/stock-list/ha-status');
